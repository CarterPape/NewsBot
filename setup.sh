...
printf "DEFAULT_EMAIL_RECIPIENTS = (something like: Your Name <your@email.address>, "
printf "a.second.address@domain.com) "
...
printf "DEFAULT_EMAIL_RECIPIENTS='$email_recipient'\n" >> "$project_path/.env"
